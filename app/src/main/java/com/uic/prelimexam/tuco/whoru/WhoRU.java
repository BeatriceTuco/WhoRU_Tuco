...
public class WhoRU {
    ...
    public void initialize(){
        ...
        choices[0][0] = "Interacting with many, \n including strangers";
        choices[0][1] = "Interact with a few,\n known to you";
        ...
        choices[7][0] = "Stay late,\n with increasing energy";
        choices[7][1] = "Leave early\n with decreasing energy";
        ...
        choices[14][0] = "Keep abreast of others \nhappenings";
        ...
        choices[38][1] = "To arrive at agreement\n on an issue";
        ...
        questions[49] = "Do you?";
        choices[49][0] = "Speak easily and at \nlength with strangers";
        ...
        choices[62][1] = "Allow some things \nto just come together";
