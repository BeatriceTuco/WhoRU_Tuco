...
public class WhoRUActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(WhoRUActivity.this, Main.class));
            }
        });
    ...
    public String generateTraits(){
        ...
        if(whoRU.isExtrovert()) traits+="E";
        else traits+="I";

        if(whoRU.isSensing()) traits+="S";
        else traits+="N";

        if(whoRU.isThinking()) traits+="T";
        else traits+="F";

        if(whoRU.isJudging()) traits+="J";
        else traits+="P";
